...
-   Kosiv Marta
-   Ostap Kostiuk
-   Volodymyr Legchylo Yanishevskyy
...
df %>%
  ...
  ggplot2::geom_col() +
  ggplot2::labs(title = "Class distribution (train)",
                x = "Class", y = "Count") +
...
tidy_text %>%
  ...
  ggplot2::geom_col() +
  ggplot2::coord_flip() +
  ggplot2::labs(title = "Top 20 words (after cleaning)",
                x = NULL, y = "Frequency") +
  ggplot2::theme_minimal()

# top 10 words in each class
...
ggplot2::ggplot(top_by_class, ggplot2::aes(x = reorder(word, n), y = n)) +
  ...
  ggplot2::labs(title = "Top 10 words in each class",
                x = NULL, y = "Frequency") +
  ggplot2::theme_minimal()
...
ggplot2::ggplot(doc_len, ggplot2::aes(x = len, fill = Label)) +
  ...
  ggplot2::labs(title = "Document lengths (after stop words)",
                x = "Number of words", y = "Number of documents") +
  ggplot2::theme_minimal()
